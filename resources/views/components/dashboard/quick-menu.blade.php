<section class="space-y-2">
    ...
    <div class="grid grid-cols-2 gap-2">
        <a href="{{ route('dashboard.estates') }}" wire:navigate
            class="rounded-xl border border-blue-100 bg-blue-50 p-3 text-xs font-bold text-blue-700">
            Kelola Listing Properti
        </a>
        <div class="rounded-xl border border-gray-100 bg-white p-3 text-xs font-bold text-gray-500">
        ...
        <a href="{{ route('profile') }}" wire:navigate
            class="rounded-xl border border-gray-100 bg-white p-3 text-xs font-bold text-gray-500">
