...
<div {{ $attributes->class('relative w-full overflow-hidden bg-slate-100') }}>

    <div aria-hidden="true" class="pointer-events-none absolute inset-0 z-0">

        @if ($rails)
            {{-- Primary vertical rails --}}
            <div class="structural-rail absolute inset-y-0 left-[4%] w-px sm:left-[6%] lg:left-[8%]"></div>
            <div class="structural-rail absolute inset-y-0 right-[4%] w-px sm:right-[6%] lg:right-[8%]"></div>

            {{-- Inner desktop rails --}}
            <div class="structural-rail-light absolute inset-y-0 left-[16%] hidden w-px lg:block"></div>
            <div class="structural-rail-light absolute inset-y-0 right-[16%] hidden w-px lg:block"></div>
        ...
        @if ($dots)
            {{-- Primary dot field --}}
            <div
                class="structural-dot-field absolute right-[2%] top-[-30px] h-[460px] w-[460px] opacity-70 sm:right-[6%] lg:right-[10%]"></div>
            </div>

            {{-- Secondary dot field --}}
            <div
                class="structural-dot-field-small absolute bottom-[6%] left-[1%] h-[300px] w-[360px] opacity-60 sm:left-[5%] lg:left-[11%]">
            </div>
        @endif
