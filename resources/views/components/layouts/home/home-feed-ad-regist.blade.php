<div
    ...
    <a href="{{ auth()->check() ? route('estates.create') : route('login') }}" wire:navigate
        class="inline-flex shrink-0 items-center justify-center border border-slate-300 bg-white px-4 py-2.5 text-xs font-bold text-slate-800 shadow-[3px_3px_0_0_rgba(15,23,42,0.05)] transition duration-150 hover:border-sky-300 hover:text-sky-700">
        Tambahkan properti
