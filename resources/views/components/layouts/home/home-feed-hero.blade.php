<div class="px-4">
    <div class="flex items-center gap-3 overflow-x-auto no-scrollbar py-1">
        <button wire:click="$set('category', '')" class="flex flex-col items-center gap-1.5 shrink-0 group">
            <div
                class="w-12 h-12 rounded-md bg-blue-50 text-blue-600 flex items-center justify-center group-hover:bg-blue-600 group-hover:text-white transition-all shadow-sm">
        ...
        <button wire:click="$set('category', 'rumah')" class="flex flex-col items-center gap-1.5 shrink-0 group">
            <div
                class="w-12 h-12 rounded-md bg-gray-50 text-gray-600 flex items-center justify-center group-hover:bg-blue-600 group-hover:text-white transition-all shadow-sm">
                <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8"
