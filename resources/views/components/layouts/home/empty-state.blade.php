...
<div class="mx-4 rounded-2xl border border-dashed border-blue-200 bg-blue-50/60 p-6 text-center">
    ...
    @if ($showReset)
        <button wire:click="resetFilter" class="mt-4 rounded-xl bg-blue-600 px-4 py-2 text-xs font-bold text-white">
            Reset filter
        </button>
    @endif
</div>
