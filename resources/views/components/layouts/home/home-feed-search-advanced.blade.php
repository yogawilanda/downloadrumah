...
<div x-show="openSearchModal" x-cloak class="fixed inset-0 z-50 flex items-center justify-center p-4">
    ...
    <div x-show="openSearchModal" x-transition:enter="transition ease-out duration-200 transform"
        ...
        class="w-full max-w-sm bg-white rounded-2xl shadow-2xl z-10 p-5 space-y-4 relative border border-gray-100">
        ...
        <div class="space-y-3.5">
            <!-- Input Kata Kunci -->
            <div>
                <label class="block text-[11px] font-semibold text-gray-600 mb-1">Cari Kata Kunci /
                    Lokasi</label>
                <input wire:model.live.debounce.300ms="search" type="text"
                    placeholder="Contoh: Perumahan Asri, Gubeng..."
            ...
            <div>
                <label class="block text-[11px] font-semibold text-gray-600 mb-1">Batas Maksimal Harga
                    (Rp)</label>
