...
<div x-show="openSearchModal" x-cloak class="fixed inset-0 z-50 flex items-center justify-center p-4">
    ...
    <div x-show="openSearchModal" x-transition:enter="transition ease-out duration-200 transform"
        ...
        class="w-full max-w-sm bg-white rounded-md shadow-2xl z-10 p-5 space-y-4 relative border border-gray-100 max-h-[90vh] overflow-y-auto">
        ...
        <div class="space-y-3.5">
            ...
            <div>
                ...
                <input wire:model.live.debounce.300ms="search" type="text"
                    ...
                    class="w-full px-3 py-2 bg-gray-50 border border-gray-200 text-xs rounded-md focus:ring-2 focus:ring-blue-500 focus:bg-white text-gray-800 placeholder-gray-400 transition" />
            </div>
        ...
        <div class="pt-2 flex items-center gap-2">
            <button type="button" wire:click="resetFilter" @click="openSearchModal = false"
                class="flex-1 py-2 bg-gray-100 text-gray-600 text-xs font-semibold rounded-md hover:bg-gray-200 transition">
                Reset
            </button>
