...
<div
    class="fixed left-0 right-0 top-0 z-40 flex items-center justify-between
           px-4 py-3 pointer-events-none lg:hidden"
>
...
>
    ...
    <div
        ...
        class="relative z-10 w-full max-w-xs space-y-5 border border-slate-200
               bg-white p-6 shadow-2xl dark:border-slate-700 dark:bg-slate-900
               sm:max-w-sm"
    >
        ...
        <div class="space-y-2.5">
            ...
            <button
                ...
                "
                class="flex w-full items-center gap-3.5 border border-slate-200
                       bg-slate-50 p-3.5 text-left transition-all
        ...
        <div class="space-y-4">
            ...
            <div>
                ...
                <input
                    ...
                    class="w-full border border-slate-200 bg-slate-50 px-4 py-3
                           text-xs text-slate-800 outline-none transition-all
...
<div
    x-show="toastModal"
    x-cloak
    class="pointer-events-none fixed inset-x-0 bottom-6 z-50 flex
...
>
    ...
    <div
        class="pointer-events-auto flex max-w-xs items-center gap-3
               ...
               text-white shadow-2xl dark:border-slate-700 dark:bg-black"
    >
        <svg
