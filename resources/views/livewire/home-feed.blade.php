<div class="max-w-md mx-auto min-h-screen bg-gray-50 pb-20">
    ...
    <div class="sticky top-0 z-30 bg-white/95 backdrop-blur-md px-4 pt-4 pb-3 border-b border-gray-100 shadow-sm">
        <div class="flex items-center justify-between mb-3">
            ...
            @auth
                <a href="{{ route('dashboard') }}" class="text-xs font-semibold text-indigo-600 bg-indigo-50 px-3 py-1.5 rounded-full">Dashboard</a>
            @else
                <a href="{{ route('login') }}" class="text-xs font-semibold text-gray-600 bg-gray-100 px-3 py-1.5 rounded-full">Masuk</a>
            @endauth
        </div>
        ...
        <div class="flex items-center space-x-2 overflow-x-auto no-scrollbar py-1">
            ...
            <!-- Dropdown Kota -->
            <select wire:model.live="city" class="px-3 py-1.5 text-xs font-medium rounded-full bg-gray-100 text-gray-600 border-none focus:ring-0">
