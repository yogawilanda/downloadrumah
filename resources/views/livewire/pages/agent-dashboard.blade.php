...
<div class="w-full pb-32 pt-4 px-4 max-w-md mx-auto space-y-4">
    ...
    <div class="bg-white p-4 rounded-2xl border border-gray-100 shadow-sm flex items-center justify-between">
        <div>
            ...
            <p class="text-xs text-gray-500 mt-0.5">Ruang kerja properti</p>
            <span class="mt-2 inline-block rounded-full bg-blue-50 px-2 py-1 text-[10px] font-bold text-blue-600">User / Agent MVP</span>
        </div>
    ...
    <div class="grid grid-cols-3 gap-2">
        <div class="bg-white p-3.5 rounded-2xl border border-gray-100 shadow-sm">
            <p class="text-[10px] font-semibold text-gray-400 uppercase tracking-wider">Iklan Saya</p>
            <p class="text-2xl font-black text-blue-600 mt-0.5">{{ $listingCount }}</p>
        </div>
        <div class="bg-white p-3.5 rounded-2xl border border-gray-100 shadow-sm">
            <p class="text-[10px] font-semibold text-gray-400 uppercase tracking-wider">Favorit</p>
            <p class="text-sm font-bold text-gray-400 mt-2">Soon</p>
        </div>
        <div class="bg-white p-3.5 rounded-2xl border border-gray-100 shadow-sm">
            <p class="text-[10px] font-semibold text-gray-400 uppercase tracking-wider">Status Akun</p>
            <p class="text-sm font-bold text-emerald-600 mt-2">Akun Pengguna</p>
        </div>
    </div>
    ...
    <div class="space-y-2.5">
        <div class="flex items-center justify-between px-1">
            ...
            <a href="{{ route('dashboard.estates') }}" wire:navigate class="text-xs font-bold text-blue-600 hover:underline">
                Lihat Semua
            </a>
        </div>
