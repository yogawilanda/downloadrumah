    ...
    <div class="max-w-md mx-auto bg-white min-h-screen shadow-sm px-4 py-6">
        ...
        <div class="mb-6 flex items-center gap-3">
            <a href="{{ route('home') }}" wire:navigate
                class="p-2 bg-gray-100 rounded-md text-gray-600 hover:bg-gray-200 transition">
        ...
        <div class="space-y-4">
            ...
            <section class="space-y-2">
                ...
                <a href="https://wa.me/6285158986696?text=Halo%20Tim%20DownloadRumah,%20saya%20butuh%20bantuan"
                    ...
                    <div class="flex items-center gap-3">
                        <div
                            class="w-9 h-9 bg-green-100 text-green-600 rounded-md flex items-center justify-center shrink-0">
            ...
            <section class="space-y-2 pt-2">
                ...
                <div class="bg-gray-50 p-4 rounded-md border border-gray-100 space-y-3 text-xs text-gray-600">
                    <div>
