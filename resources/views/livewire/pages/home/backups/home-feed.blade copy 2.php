...
<div class="w-full min-h-screen bg-white" x-data="{ openSearchModal: false, activeTab: 'all' }" @open-search-modal.window="openSearchModal = true">
    ...
    <div class="w-full max-w-6xl mx-auto pb-24 md:pb-12 pt-36 overflow-x-hidden">

        <div class="p-5 md:p-8 pt-36 md:pt-12">

            {{-- 1. EDITORIAL HERO SECTION (Flexbox Layout) --}}
            <div class="flex flex-col lg:flex-row items-center gap-10 w-full relative z-10  pt-36 pb-36 lg:pb-24">

                {{-- Kiri: Text Content --}}
                <div class="w-full lg:w-1/2 space-y-6">
                    <div class="inline-flex items-center gap-2 px-3 py-1.5 rounded-md bg-sky-50 border border-sky-100 text-sky-700 text-xs font-semibold">
                        <span class="w-2 h-2 rounded-md bg-sky-500 animate-pulse"></span>
                        Privasi Terjamin 100%
                    </div>

                    <h1 class="text-5xl lg:text-7xl font-black tracking-tighter leading-[1.05] text-slate-900">
                        Marketplace <br/>
                        <span class="text-transparent bg-clip-text bg-gradient-to-r from-slate-900 to-sky-600">Properti Privat</span><br/>
                        & Terpercaya.
                    </h1>
                ...
                <div class="hidden lg:block lg:w-1/2 relative h-[450px] w-full">
                    {{-- Card Beli --}}
                    <div class="absolute bottom-0 left-0 w-[240px] h-[360px] rounded-md overflow-hidden shadow-2xl z-20 border border-slate-200">
                        ...
                        <div class="absolute top-0 bottom-0 left-4 flex items-center">
                            <span class="text-6xl font-black text-white tracking-tighter transform -rotate-90 origin-center">Beli</span>
                        </div>
                    </div>
                    {{-- Card Sewa --}}
