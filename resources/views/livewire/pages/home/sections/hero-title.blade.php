<div x-data="{
    ...
    <div
        class="mb-5 flex items-center gap-2 text-[10px] font-bold
               uppercase tracking-[0.2em] text-sky-600">
    ...
    <h1
        ...
        <span class="inline-flex flex-wrap items-baseline">
            ...
            <span class="word-reveal mx-1.5 text-sky-600" x-text="visibleWord"></span>

            <span>yang kamu butuhkan.</span>
        </span>

        <br class="hidden sm:block">
        {{-- add span to mencari and cocok menjadi warna biru --}}
        <span>
            {{ $intent === 'search' ? 'Temukan yang cocok.' : 'Temukan yang mencari.' }}
        </span>
    </h1>
