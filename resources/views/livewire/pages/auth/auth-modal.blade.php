...
>
    <div>
        ...
        <div class="bg-gray-100 p-1 rounded-md flex items-center mb-6 relative">
            <button @click="mode = 'login'" :class="mode === 'login' ? 'bg-white text-blue-600 shadow-sm' : 'text-gray-500'" class="w-1/2 py-2.5 text-xs font-bold rounded-md transition-all duration-200">Masuk</button>
            <button @click="mode = 'register'" :class="mode === 'register' ? 'bg-white text-blue-600 shadow-sm' : 'text-gray-500'" class="w-1/2 py-2.5 text-xs font-bold rounded-md transition-all duration-200">Daftar Akun</button>
        </div>
        ...
        <div>
            <a href="#" class="w-full flex items-center justify-center gap-3 py-2.5 px-4 border border-gray-300 rounded-md text-sm font-medium text-gray-700 hover:bg-gray-50 transition shadow-sm">
