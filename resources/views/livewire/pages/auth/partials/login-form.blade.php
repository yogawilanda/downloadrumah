...
<meta_config>
    ...
    1. path__________________: resources/views/livewire/pages/auth/partials/login-form.blade.php
    2. usage_________________: DownloadRumah Authentication — Login Form
    ...
    5. expected_data_________: [$errors, $loginForm]
    6. purpose_______________: Render the login form with validation, password visibility, remember-me, and loading states.
    7. ruling________________: Authentication UI prioritizes clarity, trust, and minimal interaction friction.
    ...
    10. ruling_performance___: Preserve Livewire loading states and Alpine password visibility state.
...
>
    ...
    @if ($errors->any())
        <div
            class="mb-5 flex items-start gap-2.5 border border-rose-200 bg-rose-50
                   px-3.5 py-3 text-xs text-rose-700
                   dark:border-rose-900/70 dark:bg-rose-950/40 dark:text-rose-300"
        >
            <svg
    ...
    <form wire:submit="login" class="space-y-5">
        ...
        <div>
            ...
            <x-input-error
                :messages="$errors->get('loginForm.email') ?: $errors->get('email')"
        ...
        <div>
            <div class="mb-2 flex items-center justify-between">
                ...
                @if (Route::has('password.request'))
                    <a
                        ...
                        wire:navigate
                        class="text-[11px] font-semibold text-sky-600 transition-colors
                               duration-150 hover:text-sky-700 hover:underline
            ...
            <div class="relative">
                <input
                    ...
                    class="w-full border border-slate-300 bg-white px-3.5 py-3 pr-11
                           text-sm text-slate-900 outline-none transition-colors duration-150
                           placeholder:text-slate-300 focus:border-sky-400 focus:ring-0
                           dark:border-slate-700 dark:bg-slate-900 dark:text-slate-100
                           dark:placeholder:text-slate-600 dark:focus:border-sky-500"
                >
                ...
                <button
                    ...
                    class="absolute right-3 top-1/2 flex h-7 w-7 -translate-y-1/2
                           items-center justify-center text-slate-400 transition-colors
                           duration-150 hover:text-slate-700 focus:outline-none
            ...
            <x-input-error
                :messages="$errors->get('loginForm.password') ?: $errors->get('password')"
                class="mt-1.5 text-xs"
            />
        </div>
        ...
        <label class="flex cursor-pointer items-center gap-2">
            <input
                ...
                type="checkbox"
                class="h-4 w-4 border-slate-300 text-sky-600 shadow-none
        ...
        <div class="pt-1">
            <button
                ...
                class="relative flex h-11 w-full items-center justify-center border
                       border-slate-950 bg-slate-950 text-xs font-bold text-white
