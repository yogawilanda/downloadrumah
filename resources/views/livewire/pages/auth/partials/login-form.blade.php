...
>
    ...
    <form wire:submit="login" class="space-y-4">
        ...
        <div>
            <div class="flex items-center justify-between mb-1">
                ...
                @if (Route::has('password.request'))
                    <a class="text-xs text-blue-600 font-semibold hover:underline" href="{{ route('password.request') }}" wire:navigate>Lupa Password?</a>
                @endif
            </div>
        ...
        <label class="inline-flex items-center cursor-pointer">
            <input wire:model="loginForm.remember" type="checkbox" class="w-4 h-4 rounded border-gray-300 text-blue-600 shadow-sm focus:ring-blue-500">
        ...
        <div class="pt-2">
            <button type="submit" wire:loading.attr="disabled" class="w-full bg-blue-600 hover:bg-blue-700 active:scale-[0.98] text-white font-bold py-3.5 px-4 rounded-2xl shadow-lg shadow-blue-100 transition duration-150 flex items-center justify-center disabled:opacity-70">
                ...
                <span wire:loading wire:target="login" x-cloak class="inline-flex items-center justify-center gap-2 text-sm">
