...
<div class="w-full max-w-md mx-auto p-6 bg-white rounded-md shadow-md border border-slate-100">
    ...
    <form wire:submit="resetPassword" class="space-y-4">
        <div>
            ...
            <input wire:model="email" id="email" type="email" required class="w-full px-3 py-2 border rounded-md text-sm bg-slate-50 border-slate-300" readonly />
        </div>
        ...
        <div>
            ...
            <input wire:model.live="password" id="password" type="password" required autofocus placeholder="••••••••"
                class="w-full px-3 py-2 border rounded-md text-sm focus:ring-2 focus:ring-blue-500 @error('password') border-red-500 @else border-slate-300 @enderror" />

            <div class="mt-2 p-2.5 bg-slate-50 rounded-md text-xs space-y-1 text-slate-600 border border-slate-200">
        ...
        <div>
            ...
            <input wire:model.live="password_confirmation" id="password_confirmation" type="password" required placeholder="••••••••"
                class="w-full px-3 py-2 border rounded-md text-sm focus:ring-2 focus:ring-blue-500 @error('password_confirmation') border-red-500 @else border-slate-300 @enderror" />
        ...
        <button type="submit" wire:loading.attr="disabled"
            class="w-full py-2.5 px-4 bg-blue-600 hover:bg-blue-700 text-white font-medium text-sm rounded-md shadow-sm transition disabled:opacity-50">
