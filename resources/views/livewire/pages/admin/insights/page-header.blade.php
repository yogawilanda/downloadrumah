<div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-4 border-b border-slate-200/80">
    ...
    <button wire:click="$refresh"
        class="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-3.5 py-2 bg-white border border-slate-200 rounded-md text-xs font-bold text-slate-700 hover:bg-slate-50 active:scale-95 transition shadow-sm">
