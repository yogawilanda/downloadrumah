...
<meta_config>
    ...
    1. path__________________: resources/views/livewire/pages/admin/insights/details-card.blade.php
    2. usage_________________: Admin Insights — Card Breakdown Detail Modal
    3. type__________________: Livewire Blade View
    4. expected_data_________: [activeCardDetail, cardDetailsData]
    5. purpose_______________: Display detailed telemetry breakdown for the selected insight card.
    6. ruling________________: Presentation only; modal state and actions are delegated to Livewire.
    7. ruling_structure______: Livewire Component → Card Breakdown Detail
                        ...
                        <div class="flex items-center justify-between gap-3 py-2.5 text-xs">
                            <span
                                class="max-w-[200px] truncate font-mono text-[11px]
                                       text-slate-700 dark:text-slate-300 sm:max-w-xs"
                                title="{{ $row->key_name }}"
                            >
                                {{ $row->key_name }}
                            </span>
