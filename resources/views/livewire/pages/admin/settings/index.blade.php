    ...
    <div class="max-w-4xl mx-auto space-y-6">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 pb-4 border-b border-slate-200">
            ...
            <button wire:click="flushCache" wire:loading.attr="disabled"
                class="inline-flex items-center justify-center gap-2 px-3.5 py-2 bg-white border border-slate-300 rounded-md text-xs font-semibold text-slate-700 hover:bg-slate-50 transition shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500">
        ...
        @if ($flash)
            <div x-data="{ show: true }" x-show="show" x-transition x-init="setTimeout(() => show = false, 3000)"
                class="flex items-center justify-between p-3.5 rounded-md bg-emerald-50 border border-emerald-200 text-emerald-800 text-xs font-medium">
        ...
        <div class="space-y-6">
            @forelse ($this->grouped as $group => $rows)
                <div class="bg-white rounded-md shadow-sm border border-slate-200/80 overflow-hidden">
            ...
            @empty
                <div class="p-12 text-center bg-white rounded-md border border-dashed border-slate-300">
