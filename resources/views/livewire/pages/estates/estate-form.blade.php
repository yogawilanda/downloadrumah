...
<div class="w-full pb-28 pt-4 px-4 max-w-lg mx-auto">
    ...
    <div class="mb-4 flex items-center justify-between">
        <a href="{{ route('dashboard') }}" wire:navigate class="text-gray-600 hover:text-gray-900">
        ...
        <div class="pt-4 flex gap-3">
            ...
            @if ($currentStep < 4)
                <button type="button" wire:click="nextStep"
                    class="{{ $currentStep > 1 ? 'w-2/3' : 'w-full' }} py-3 rounded-xl bg-blue-600 text-white text-xs font-bold shadow-md active:bg-blue-700 transition">
                    Selanjutnya
                </button>
            @else
                <button type="submit" wire:loading.attr="disabled" wire:target="save"
                    class="{{ $currentStep > 1 ? 'w-2/3' : 'w-full' }} py-3 rounded-xl bg-blue-600 text-white text-xs font-bold shadow-md hover:bg-blue-700 active:bg-blue-800 transition disabled:opacity-50 disabled:cursor-not-allowed">
