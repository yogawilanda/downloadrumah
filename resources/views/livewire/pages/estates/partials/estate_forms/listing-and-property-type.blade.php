<div class="space-y-4">
    <div>
        ...
        <select wire:model="form.listing_group"
            class="w-full rounded-xl border border-gray-200 bg-gray-50/50 px-3.5 py-3 text-xs text-gray-800 focus:bg-white focus:border-blue-500 transition-all cursor-pointer">
