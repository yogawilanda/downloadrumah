<div class="space-y-4">
    ...
    <div class="bg-white p-4 rounded-xl border border-gray-100 shadow-sm space-y-3">
        ...
        <div class="grid grid-cols-4 gap-2">
            <label class="aspect-square border-2 border-dashed border-blue-400 bg-blue-50/50 rounded-xl flex items-center justify-center cursor-pointer hover:bg-blue-100/50 transition">
    ...
    <div class="bg-white p-4 rounded-xl border border-gray-100 shadow-sm space-y-4">
        ...
        <div>
            ...
            <div class="flex items-center space-x-4 text-xs">
                <label class="inline-flex items-center cursor-pointer"><input type="radio" wire:model="form.transaction_type" value="sale" class="text-blue-500 focus:ring-blue-400"><span class="ml-2">Jual</span></label>
                <label class="inline-flex items-center cursor-pointer"><input type="radio" wire:model="form.transaction_type" value="rent" class="text-blue-500 focus:ring-blue-400"><span class="ml-2">Sewa</span></label>
            </div>
        </div>
        <div>
        ...
        <div>
            ...
            <select wire:model="form.property_type" class="w-full rounded-lg border-gray-300 focus:border-blue-400 focus:ring-blue-400 text-sm">
        ...
        @foreach ([['is_kpr', 'Bisa KPR?'], ['has_imb', 'IMB / PBG?'], ['has_blueprint', 'Ada Blueprint?']] as [$field, $label])
            <div>
                ...
                <div class="flex items-center space-x-4 text-xs">
                    <label class="inline-flex items-center"><input type="radio" wire:model="form.attributes_list.{{ $field }}" value="1" class="text-blue-500"><span class="ml-2">Ya</span></label>
                    <label class="inline-flex items-center"><input type="radio" wire:model="form.attributes_list.{{ $field }}" value="0" class="text-blue-500"><span class="ml-2">Tidak</span></label>
                </div>
            </div>
        @endforeach
        <div class="border-t border-gray-100 pt-3 space-y-3">
            ...
            <div>
                ...
                <select wire:model="form.attributes_list.legal_docs" class="w-full rounded-lg border-gray-300 focus:border-blue-400 focus:ring-blue-400 text-sm">
            ...
            <div>
                ...
                <div class="flex items-center space-x-4 text-xs">
                    <label class="inline-flex items-center"><input type="radio" wire:model="form.attributes_list.agent_cooperation" value="1" class="text-blue-500"><span class="ml-2">Ya</span></label>
                    <label class="inline-flex items-center"><input type="radio" wire:model="form.attributes_list.agent_cooperation" value="0" class="text-blue-500"><span class="ml-2">Tidak</span></label>
                </div>
            </div>
        </div>
    </div>
