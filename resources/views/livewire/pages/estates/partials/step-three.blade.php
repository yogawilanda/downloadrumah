        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
            ...
            <div>
                ...
                <input type="text" wire:model="form.owner_name" placeholder="Contoh: Bpk. Agus"
                    class="w-full rounded-md border border-gray-200 bg-gray-50/50 px-3.5 py-2.5 text-xs text-gray-800 focus:bg-white focus:border-blue-500 focus:ring-2 focus:ring-blue-100 transition-all">
