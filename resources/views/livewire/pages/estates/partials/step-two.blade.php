            ...
            <div>
                ...
                <div class="relative">
                    <select wire:model.live="form.province_id"
                        class="w-full appearance-none rounded-md border border-gray-200 bg-gray-50/50 pl-3.5 pr-9 py-2.5 text-xs text-gray-800 truncate focus:bg-white focus:border-blue-500 focus:ring-2 focus:ring-blue-100 transition-all cursor-pointer">
            ...
            <div>
                ...
                <div class="relative">
                    <select wire:model.live="form.city_id" @disabled(!$form->province_id)
                        class="w-full appearance-none rounded-md border border-gray-200 bg-gray-50/50 pl-3.5 pr-9 py-2.5 text-xs text-gray-800 truncate focus:bg-white focus:border-blue-500 focus:ring-2 focus:ring-blue-100 transition-all disabled:bg-gray-100 disabled:text-gray-400 disabled:cursor-not-allowed cursor-pointer">
                        <option value="">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                <div>
                    ...
                    <input type="text" wire:model="form.block_number" placeholder="Contoh: No. 12B / Blok A"
                        class="w-full rounded-md border border-gray-200 bg-gray-50/50 px-3.5 py-2.5 text-xs text-gray-800 placeholder-gray-400 focus:bg-white focus:border-blue-500 focus:ring-2 focus:ring-blue-100 transition-all">
            ...
            @foreach ([['bedroom', 'Kamar Tidur', '1'], ['bathroom', 'Kamar Mandi', '1'], ['building_size', 'LB (m²)', '36'], ['land_size', 'LT (m²)', '60'], ['building_width', 'Lebar (m)', '6'], ['building_length', 'Panjang (m)', '10']] as [$field, $label, $placeholder])
                <div>
                    ...
                    <input type="number" @if (in_array($field, ['building_width', 'building_length'])) step="0.1" @endif
                        ...
                        class="w-full rounded-md border border-gray-200 bg-gray-50/50 px-3.5 py-2 text-xs text-gray-800 placeholder-gray-400 focus:bg-white focus:border-blue-500 focus:ring-2 focus:ring-blue-100 transition-all">
                    @error('form.' . $field)
                        <span class="text-[11px] text-red-500 mt-1 block">{{ $message }}</span>
                    @enderror
                </div>
                    ...
                    @if ($isChecked)
                        <div class="mt-2 pt-2 border-t border-blue-100/60">
                            <input type="text" wire:model="form.selected_facilities.{{ $facility->id }}.value"
                                ...
                                class="w-full text-xs rounded-md border border-gray-200 px-2 py-1 bg-white focus:border-blue-500 focus:ring-1 focus:ring-blue-500">
                        </div>
                    @endif
                </div>
            @endforeach
