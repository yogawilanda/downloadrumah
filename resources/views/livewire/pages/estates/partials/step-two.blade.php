...
<div class="space-y-4">
    ...
    <div class="bg-white p-5 rounded-2xl border border-gray-100 shadow-sm space-y-4">
        ...
        <div class="space-y-3 pt-1">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div>
                    <label class="block text-xs font-semibold text-gray-600 mb-1.5">Area / Kecamatan</label>
                    <input type="text" wire:model="form.district" placeholder="Contoh: Pandaan / Citraland"
