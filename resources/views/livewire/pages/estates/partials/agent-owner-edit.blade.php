<div class="fixed bottom-20 left-0 right-0 z-40 pointer-events-none">
    <div class="max-w-md mx-auto px-4 pointer-events-auto">
        <div class="bg-white/95 backdrop-blur-md border border-slate-200/80 p-3 rounded-2xl shadow-xl shadow-slate-900/10 flex items-center justify-between gap-3">
            ...
            <a href="{{ route('estates.edit', $estate->slug) }}" wire:navigate
                class="px-4 py-2.5 bg-blue-600 hover:bg-blue-700 text-white text-xs font-bold rounded-xl transition shadow-sm shadow-blue-200 flex items-center gap-1.5 shrink-0 active:scale-95">
