...
<div x-data="{
...
}" class="max-w-md mx-auto min-h-screen bg-gray-50 pb-24 relative">
    ...
    <div x-show="shareModal" x-cloak
        ...
        <div @click.away="shareModal = false"
            class="bg-white w-full max-w-md rounded-t-3xl sm:rounded-2xl p-5 space-y-4">
    ...
    <div x-show="toastModal" x-cloak
        ...
        <div
            class="bg-gray-900/90 text-white px-5 py-3.5 rounded-2xl shadow-xl flex items-center space-x-2.5 max-w-xs border border-gray-700">
